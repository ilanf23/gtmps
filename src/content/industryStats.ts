...
export const INDUSTRY_STATS: Record<VerticalSlug, IndustryStat[]> = {
  consulting: [
    ...
    { value: '8,200', label: 'Firms $5M–$100M revenue', source: 'Kennedy Research [SOURCE PENDING]' },
  ...
  law: [
    ...
    { value: '6,800', label: 'Firms $5M–$100M revenue', source: 'Altman Weil [SOURCE PENDING]' },
  ...
  accounting: [
    ...
    { value: '5,400', label: 'Firms $5M–$100M revenue', source: 'Inside Public Accounting [SOURCE PENDING]' },
  ...
  msp: [
    ...
    { value: '3,900', label: 'MSPs $5M–$100M revenue', source: 'ConnectWise State of SMB 2024 [SOURCE PENDING]' },
  ...
  advisory: [
    ...
    { value: '2,100', label: 'RIAs $5M–$100M AUM tier', source: 'Cerulli Associates 2024 [SOURCE PENDING]' },
  ...
  ae: [
    ...
    { value: '4,500', label: 'Firms $5M–$100M revenue', source: 'ZweigWhite 2024 [SOURCE PENDING]' },
  ...
  recruiting: [
    ...
    { value: '1,400', label: 'Firms $5M–$100M revenue', source: 'AESC 2024 [SOURCE PENDING]' },
  ...
  agency: [
    ...
    { value: '4,800', label: 'Agencies $5M–$100M revenue', source: 'Provoke Insights 2024 [SOURCE PENDING]' },
