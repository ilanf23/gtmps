    ...
    return (
      <div className="flex-1 flex items-center justify-center px-6 py-20">
        <div className="text-center max-w-md">
          <div className="w-14 h-14 rounded-full bg-[#B8933A]/15 border border-[#B8933A]/40 flex items-center justify-center mx-auto mb-6">
            <Check className="w-6 h-6 text-[#B8933A]" />
          </div>
      ...
      <div className="w-full max-w-xl">
        ...
        <form onSubmit={handleSubmit} className="flex flex-col gap-5" noValidate>
          ...
          <button
            type="submit"
            disabled={submitting}
            className="self-start bg-[#B8933A] hover:bg-[#a07c2e] text-[#120D05] font-semibold uppercase tracking-wider text-sm px-8 py-3 rounded transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
          >
