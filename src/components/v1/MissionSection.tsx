    ...
    <section id="mission" className="px-6 py-20 md:px-20 md:py-28 bg-warm-white overflow-hidden">
      <div className="max-w-[1080px] mx-auto">
              ...
              >
                ...
                <div className="flex items-start gap-5">
                  <div
                    ...
                    style={{ width: 48, height: 48, background: "rgba(184,147,58,0.06)" }}
                  >
                    <Icon size={22} className="text-gold" strokeWidth={1.5} />
                  </div>
                  <div className="flex-1 min-w-0">
                    <span className="font-mono uppercase text-gold block mb-2" style={{ fontSize: 10, letterSpacing: "0.14em" }}>
                      {card.accent}
                    </span>
                    <h3 className="font-display font-bold text-text-dark" style={{ fontSize: 19, lineHeight: 1.25 }}>
                      {card.headline}
                    </h3>
        ...
        <div className="flex items-center justify-center gap-4 my-16">
          ...
          <span className="font-mono uppercase tracking-[0.2em]" style={{ fontSize: 9, color: "rgba(0,0,0,0.3)" }}>
            The Three Pillars
          </span>
          <div className="flex-1 h-px" style={{ background: "rgba(0,0,0,0.08)" }} />
        </div>
              ...
              >
                <div className="flex items-center justify-between mb-5">
                  <div
                    ...
                    style={{ width: 44, height: 44, background: "rgba(184,147,58,0.06)" }}
                  >
                  ...
                  <div className="text-right">
                    ...
                    <span className="font-mono uppercase block" style={{ fontSize: 8, color: "rgba(0,0,0,0.35)", letterSpacing: "0.1em" }}>
                      {pillar.stat.label}
                    </span>
                  </div>
                </div>
