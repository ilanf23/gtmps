...
const DeeperSection = () => {
  ...
  const articles = [
    ...
    },
    {
      ...
      body: "The self assessment that every managing partner should run before doing anything else with their business development system. Zero infrastructure to fully built machine. Where does your firm actually sit today?",
    },
  ];
    ...
    <section id="deeper" className="px-6 py-16 md:px-20 md:py-24 bg-soft-navy">
      <div className="max-w-[1080px] mx-auto stagger-children">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-5 mt-10">
          {articles.map((a) => (
            <div key={a.tag} className="glass-card p-8 scroll-reveal">
