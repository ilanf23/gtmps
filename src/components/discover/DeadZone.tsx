  ...
  return (
    ...
    >
      <style>{`
        ...
        .dz-bar-dead {
          --target-w: 70%;
          background: rgba(237, 245, 236,0.18);
        ...
        .dz-bar-pct-dead { color: rgba(237, 245, 236,0.55); }
        .dz-bar-pct-active { color: #A8923A; text-align: right; }
        .dz-bar-tag {
          font-family: 'Inter Tight', sans-serif;
          font-size: 13px;
        ...
        .dz-bar-tag-dead { color: rgba(237, 245, 236,0.4); }
        .dz-bar-tag-active { color: #A8923A; text-align: right; }
        .dz-body {
          display: flex;
          flex-direction: column;
          gap: 24px;
        ...
        .dz-finale {
          border-top: 1px solid rgba(168, 146, 58,0.2);
          padding-top: 40px;
        }
        .dz-finale-line {
          font-family: 'Inter Tight', sans-serif;
        ...
        .dz-finale-line-1 { color: #A8923A; margin-bottom: 8px; }
        .dz-finale-line-2 { color: #EDF5EC; }
        .dz-quote {
        ...
        .dz-calc-input:focus { border-color: rgba(168, 146, 58,0.7); }
        .dz-calc-input::placeholder { color: rgba(237, 245, 236,0.3); }
        .dz-calc-sep {
          font-family: 'Inter Tight', sans-serif;
          font-size: 16px;
          color: rgba(237, 245, 236,0.45);
