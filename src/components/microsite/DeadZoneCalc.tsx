...
export default function DeadZoneCalc({ defaultContacts, defaultValue, defaultRate }: Props) {
  ...
  return (
    ...
    >
      ...
      >
        ...
        />
        <h4 className="text-white font-semibold text-[17px] relative" style={{ fontFamily: "'Playfair Display', serif" }}>
      ...
      <div className="p-7 space-y-7">
        ...
        <div className="text-center pt-6 mt-2 relative" style={{ borderTop: "1px solid rgba(221,213,204,0.4)" }}>
          <div
            ...
            style={{ fontFamily: "'Playfair Display', serif", color: "#C65D3E", textShadow: "0 0 30px rgba(198,93,62,0.15)" }}
          >
