...
import type { OrbitRing } from "@/types/microsite";
...
const RING_RADII = [55, 100, 150, 200, 250];

export default function OrbitMap({ rings, centerLabel }: Props) {
