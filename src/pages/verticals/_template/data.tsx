...
export const consulting: VerticalConfig = {
  ...
  audit: {
    ...
    questions: [
      ...
      "Is new business owned by individual partners rather than a firm-level function?",
      "Is the BD plan undocumented (no named accounts, owners, or cadence in writing)?",
...
export const law: VerticalConfig = {
  ...
  audit: {
    ...
    questions: [
      ...
      "Is origination owned by individual partners rather than a firm-level function?",
      "Is the origination plan undocumented (no named accounts, owners, or cadence in writing)?",
